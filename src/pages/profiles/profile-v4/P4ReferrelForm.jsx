...
export default function P4ReferrelForm({ profileUserId, visitorInfo,IsReferalForm,setIsReferalForm }) {
        ...
        <React.Fragment>
            ...
            >
             <BriefcaseIcon/> <span>Refer Business</span>
                */}
                <button className={`${style.button}`} onClick={() => { setOpen(true) }} data-bs-toggle="modal" data-bs-target="#formModal"><span className={`${style.buttonText}`}>Refer Business </span> 
                <span className={`${style.iconsSpan}`}><FiExternalLink className={`${style.icons}`} /></span>
                </button>
            {/* </button> */}
            <Dialog
                open={open}
