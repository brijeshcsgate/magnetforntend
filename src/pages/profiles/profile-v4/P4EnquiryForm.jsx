...
export default function P4EnquiryForm({ profileUserId, visitorInfo,cl }) {
    ...
    return (
        <React.Fragment>
            ...
            <button className={`${style.button}`}  onClick={() => { setOpen(true) }}><span className={`${style.buttonText}`}>Enquiry </span> <span className={`${style.iconsSpan}`}><BiSearchAlt2 className={`${style.icons}`} /></span></button> 
            <Dialog
                open={open}
                onClose={handleClose}
