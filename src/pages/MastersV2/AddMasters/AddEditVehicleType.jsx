...
const AddEditVehicleType = () => {
  ...
  useEffect(() => {
    if (id) {
      setLoading(true);
      getApi(APIS.VEHICLE_TYPE, id)
        .then((res) => {
          const editData = res?.data?.vehicleType;
          setData((prev) => ({
            ...prev,
  ...
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    if (id) {
      payload._id = id;
      patchApi(APIS.VEHICLE_TYPE, id, payload).then(() => {
        toast.success("Data updated successfully");
        navigate(-1);
      });
    } else {
      postApi(APIS.VEHICLE_TYPE, payload)
        .then(() => {
              ...
              <>
                <Header>
                  <div>
                    ...
                    />
                    <Heading>{id ? "Edit" : "Add"} Vehicle Type</Heading>
                  </div>
                  <ButtonContainer>
                    <Button
                ...
                <Content>
                  <Section>
                    <SidePanel
                      ...
                      description={`Enter Vehicle Type Detail`}
                    />
                    <InputsContainer>
                      ...
                      <div className=" pb-4 md:w-1/3">
                        <FormikTextField
                          label="Vehicle Type Short Name"
                          placeholder="Enter Vehicle Type Short Name"
