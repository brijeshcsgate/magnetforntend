...
const AddEditTransmissionType = () => {
  ...
  useEffect(() => {
    if (id) {
      setLoading(true);
      getApi(APIS.TRANSMISSION_TYPE, id)
        .then((res) => {
          const editData = res?.data?.transmissionType;
          setData((prev) => ({
            ...prev,
  ...
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    if (id) {
      payload._id = id;
      patchApi(APIS.TRANSMISSION_TYPE, id, payload).then(() => {
        toast.success("Data updated successfully");
        navigate(-1);
      });
    } else {
      postApi(APIS.TRANSMISSION_TYPE, payload)
        .then(() => {
            ...
            {loading ? (
              ...
              <>
                <Header>
                  <div>
                    <BreadCrumbs
                      ...
                      boldItem={"Transmission Type"}
                    />
                    <Heading>{id ? "Edit" : "Add"} Transmission Type</Heading>
                  </div>
                  <ButtonContainer>
                    <Button
                ...
                <Content>
                  <Section>
                    <SidePanel
                      title={`Add Transmission Type (En)`}
                      description={`Enter Transmission Type Detail`}
                    />
                    <InputsContainer>
                      <div className="flex gap-8">
                        <div className=" pb-4 md:w-1/3">
                          <FormikTextField
                            ...
                            placeholder="Enter Transmission Type Name"
                            name="englishName"
                            isRequired={true}
                          />
                        </div>
                      ...
                      <div className=" pb-4 md:w-1/3">
                        <FormikTextField
                          label="Transmission Type Short Name"
                          placeholder="Enter Transmission Type Short Name"
                  ...
                  <Section>
                    <SidePanel
                      title={`Add Transmission Type (Hi)`}
                      description={`Enter Transmission Type Detail`}
                    />
...
export default AddEditTransmissionType;
