...
const AddEditContractor = () => {
  ...
  useEffect(() => {
    if (id) {
      setLoading(true);
      getApi(APIS.CONTRACTOR, id)
        .then((res) => {
          const editData = res?.data?.contractor;
          setData((prev) => ({
            ...prev,
            name: {
  ...
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    if (id) {
      payload._id = id;
      patchApi(APIS.CONTRACTOR, id, payload)
        .then(() => {
      ...
      postApi(APIS.CONTRACTOR, payload)
        .then(() => {
            ...
            {loading ? (
              ...
              <>
                <Header>
                  <div>
                    <BreadCrumbs
                      ...
                      boldItem={'Contractor'}
                    />
                    <Heading>{id ? 'Edit' : 'Add'} Contractor</Heading>
                  </div>
                  <ButtonContainer>
                    <Button
                ...
                <Content>
                  <Section>
                    <SidePanel
                      title={`Add Contractor (En)`}
                      description={`Enter Contractor Detail Here`}
                    />
                        ...
                        <div className=" pb-4 md:w-1/3">
                          <FormikTextField
                            ...
                            onChange={(e) => {
                              ...
                              setFieldValue('address.billing', value);
                            }}
                          />
                        </div>
                        <div className=" pb-4 md:w-1/3">
                          <FormikTextField
                            ...
                            onChange={(e) => {
                              ...
                              setFieldValue('address.communication', value);
                            }}
                          />
                        </div>
                      </div>
